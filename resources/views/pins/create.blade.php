            ...
            <div class="ml-4 mr-4 ">
                ...
                <div class="mt-10 grid grid-cols-1 gap-x-6 gap-y-8 sm:grid-cols-6">
                    <div class="sm:col-span-4">
                        <label for="title" class="block text-sm font-medium leading-6 dark:text-gray-200 text-gray-800">{{__('Title')}}</label>
                        <div class="columns-2">
                            <div
                    ...
                    <div class="sm:col-span-4">
                        ...
                        <div>
                            <button type="submit" class="cursor-pointer justify-end rounded-md bg-blue-500 mt-3 py-3 px-4">{{__('Create')}}</button>
                        </div>
                </div>
            </div>
        </form>
